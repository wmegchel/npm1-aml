...
adts <- c("CD117", "CD45RA",  "CD69", "HLA-DR", "CD38") 
...
scale_color_viridis_c(limits = c(-5,5), oob = squish) + # set all data to range [-4, 4] and set out of boundary (oob) values to these limits
facet_wrap(~ADT, nrow = 1) + 
theme_void()

# Save as PDF
ggsave("scTapestri/img/SupFig4d_featureplots_selected_ADTs.pdf", width = 10, height = 4)
