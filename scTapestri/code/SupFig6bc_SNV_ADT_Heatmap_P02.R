...
# May 02, 2025
#
# Heatmap of the SNV, CNV and ADT for a selected patient (here patient P02)
##################################################################################
...
# Save PDF
pdf(file = sprintf("scTapestri/img/SupFig6bc_heatmap_%s.pdf", donor), width = 12, height = 14)
